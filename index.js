...
exports.encodeGray = function(pix_buffer, width, height, stride, quality) {
...
exports.encodeRGB = function(pix_buffer, width, height, stride, quality) {
	assert(utils.isBuffer(pix_buffer))
	assert((width|0) > 0 && (height|0) > 0)
...
exports.encodeRGBA = function(pix_buffer, width, height, stride, quality) {
	assert(utils.isBuffer(pix_buffer))
	assert((width|0) > 0 && (height|0) > 0)
...
exports.decodePng24 = function(data_buffer) {
...
exports.decodePng32 = function(data_buffer) {
	assert(utils.isBuffer(data_buffer))
	assert(data_buffer.length > 0)
